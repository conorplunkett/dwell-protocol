...
/// @title DWELL — the attention-ad token
...
contract DWELL is ERC20, ERC20Burnable, ERC20Permit {
    uint256 public constant TOTAL_SUPPLY = 1_000_000_000e18;

    constructor(address treasury) ERC20("DWELL", "DWELL") ERC20Permit("DWELL") {
        require(treasury != address(0), "DWELL: treasury is zero");
