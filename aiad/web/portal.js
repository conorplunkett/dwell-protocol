// AIAD — signed-in portal (portal.html). Email magic-link or OAuth sign-in,
...
const SESSION_KEY = "aiad_session";
const PENDING_LINK_KEY = "aiad_pending_link";
const DEV_KEY = "aiad_dev";
...
function buildMock() {
  ...
  return {
    ...
    rows, series, friends,
    affiliate: {
      code: "AIAD7F3K", rewardPct: 15, capPeople: 1000, attributedCount: 4,
...
// The checkbox and the A$ logo are both server truth — the user can't tick the
