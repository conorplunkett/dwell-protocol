# Submitting DWELL to the Chrome Web Store

Step-by-step guide to publish (and later update) the DWELL Chrome extension on
...
This writes `chrome-extension/dist/dwell-chrome-v<version>.zip` containing
...
`chrome-extension/dist/dwell-chrome-v<version>.zip`. The console reads the
