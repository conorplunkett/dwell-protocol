// Terminal color helpers for the DWELL ad line.
//
...
// DWELL / Claude accent (#d97757). The default ad color when an advertiser
...
// Resolve the rgb the ad line should use: a valid advertiser color wins;
// otherwise fall back to the DWELL / Claude accent orange so an uncolored ad
// reads as native next to Claude's spinner.
export function resolveAdColor({ color } = {}) {
  return hexToRgb(color) || ACCENT_RGB;
}
